...
{
    public partial class FormPhimLe : Form
    {
        public FormPhimLe()
        {
            InitializeComponent();
        ...
        private void FormPhimLe_Load(object sender, EventArgs e)
        {
            LoadImages();
        }
        ...
        private void LoadImages()
        {
            try
            {
                List<Movies> allMovies = MoviesService.GetAllMoviesByMovieType(true);
                List<string> allImagePaths = ImagesService.GetImagesDataByMovieType(true);
        ...
        private void FormPhimLe_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (Const.isExit)
            {
                Application.Exit();
